...
def build_dataset(dataset, batch_size, input_dir=None, labeled_only=False):
    ...
    if dataset == Dataset.C10:
        ...
        train_dataset = datasets.STL10(root='/root/data/',
                                       split=train_split,
                                       transform=train_transform,
                                       download=True)
        test_dataset = datasets.STL10(root='/root/data/',
                                      split='test',
                                      transform=test_transform,
                                      download=True)
...
def build_dataset_whole(dataset, batch_size, input_dir=None, labeled_only=False):
